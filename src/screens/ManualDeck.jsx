  ...
  return (
    <div className="card-in flex w-full max-w-[88vw] flex-col items-center gap-7">
      <div className="flex flex-col items-center gap-2 text-center">
        <p className="text-[24px] leading-[1.3] tracking-[-1.2px] text-[#333]" style={{ fontFamily: HELVETICA, fontWeight: 400 }}>
          This moment came without its story.
        </p>
        <p className="max-w-[360px] text-[15px] leading-[1.3] tracking-[0.15px] text-[#595959]" style={{ fontFamily: HELVETICA, fontWeight: 300 }}>
      ...
      <div className="flex items-center gap-5" style={{ fontFamily: HELVETICA }}>
        ...
        <span className="text-[14px] tracking-[0.3px] text-[#767676]">
          {i + 1} of {items.length}
        </span>
  ...
  return (
    <button
      ...
      className={`flex h-9 w-9 items-center justify-center rounded-full text-[22px] leading-none transition-colors ${
        disabled ? 'cursor-default text-[#d2d2d2]' : 'text-[#333] hover:bg-[#f2f2f2] hover:text-[#111]'
      }`}
    >
      {dir}
    </button>
